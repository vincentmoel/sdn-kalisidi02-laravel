...
@section('container')
    ...
    <div class="container" style="background-image: linear-gradient(to right bottom, #f8eed8, #e8ead4, #d8e6d3, #c9e2d4, #bddcd6); border-radius: 10px;">
                ...
                <div class="row justify-content-center row-cols-lg-5 row-cols-2 g-4 my-4">
                    <div class="col">
                        <div class="card border-dark pict-guru-staff">
                            <img src="/images/gurustaff-ex.png" class="img-card-top" alt="">
                            <div class="card-body text-center   ">
                                <h5 class="card-title">nama</h5>
                                <p class="mb-0">jabatan</p>
                                <p class="mb-0">nip</p>
